...
import "./Tempertaure.css"
import { BsDroplet } from "react-icons/bs"

function Temperature({ temperature, active }) {
  ...
  return (
    <div>
      ...
      <div className={`temp-container ${active ? "active" : ""}`}>
        <div className="icons">
          <svg
            stroke="currentColor"
            fill="currentColor"
          ...
          >
            <g id="Temp_High" dataname="Temp High">
              <g>
                ...
                <path d="M13.893,17.169a1.89,1.89,0,0,1-3.78,0,1.858,1.858,0,0,1,1.39-1.81V5.4a.5.5,0,0,1,1,0v9.96A1.869,1.869,0,0,1,13.893,17.169Z"></path>
              </g>
            </g>
          </svg>
        ...
        {temperature.map((temp, index) => {
          return (
            <div className={`temp temp-${index + 1}`} key={index}>
              {temp}
            </div>
          )
        })}
